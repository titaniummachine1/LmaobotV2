...
local function OnDraw()
    ...
    local currentY = 120
    G.Navigation.currentNodeIndex = Navigation.GetCurrentNodeid()
    ...
    -- Draw current path
    if Menu.Visuals.drawPath and currentPath then
    ...
    -- Draw current node
    if Menu.Visuals.drawCurrentNode and currentPath then
        draw.Color(255, 0, 0, 255)

        local currentNode = currentPath[G.Navigation.currentNodeIndex]
